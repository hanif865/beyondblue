      ...
      <div className="lg:flex">
        <div className="lg:w-2/3">
          ...
          <div className="xl:flex items-center py-0 gap-1">
            <div className="xl:w-[45%] p-5 flex flex-col items-center text-center border border-[#8A9099]">
            ...
            <div className="xl:w-[25%] p-5 border border-[#8A9099]">
            ...
            <div className="xl:w-[30%] p-5 border border-[#8A9099]">
