...
const Index = props => {
        ...
        <div className="container md:w-5/6 ">
          <div className="lg:flex">
            <div className="lg:w-2/3">
              ...
              <div className="md:container py-10">
                <div className="lg:flex items-center py-0 gap-1 py-5  mb-1">
                  <a href="mailto:info@beyondbleu.com" className="mb-1 bg-white xl:w-1/2
 no-underline flex flex-col items-center text-center">
                    ...
                    <a href="tel:03-5962-3883" className="mb-1 bg-white xl:w-1/2
 no-underline flex flex-col items-center text-center">
